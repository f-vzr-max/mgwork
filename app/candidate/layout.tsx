...
//
// Inline FR copy — no `useTranslations` yet.
...
const NAV_ITEMS: SidebarItem[] = [
  { id: "home", label: "Accueil", icon: "home", href: "/candidate" },
  { id: "docs", label: "Documents", icon: "file-text", href: "/candidate/documents" },
  { id: "jobs", label: "Offres", icon: "briefcase", href: "/candidate/matches" },
  { id: "apps", label: "Candidatures", icon: "circle-dot", href: "/candidate/applications" },
  { id: "chat", label: "Chat", icon: "message-circle", href: "/candidate/chat" },
];
